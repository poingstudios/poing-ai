...
TRIAGE_FOOTER = (
    "\n\n---\n"
    f"<sub>[<img src=\"{POING_LOGO_URL}\" width=\"14\" height=\"14\" valign=\"middle\" alt=\"\" /> Triaged by **Poing AI**](https://github.com/poingstudios/poing-ai) · ⭐ Leave a star to support the project!</sub>"
)
...
class Config:
    def __init__(
        ...
        raw_grounding = get_env_optional("ENABLE_SEARCH_GROUNDING", "false").strip().lower()
        env_grounding = raw_grounding in ("true", "1", "yes", "on")
